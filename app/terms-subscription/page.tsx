        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none" style={{ fontFamily: 'sofia-pro, sans-serif' }}>
            <p className="text-gray-600 mb-6">
              <strong>Effective as of March 20, 2026</strong>
            </p>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-black">Agreement between User and The Piped Peony, LLC.</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                Welcome to The Piped Peony Academy (the &ldquo;Academy.&rdquo;) The Academy website (the &ldquo;Site&rdquo;) is comprised of various web pages operated by The Piped Peony (&ldquo;The Piped Peony&rdquo;). The Academy is offered to you conditioned on your acceptance without modification of the terms, conditions, and notices contained herein (the &ldquo;Terms&rdquo;). Your use of the Academy&rsquo;s Site constitutes your agreement to all such Terms. Please read these terms carefully, and keep a copy of them for your reference.
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                The website offers monthly memberships for subscribers to receive decorative culinary tutorials and other related-content, in exchange for a monthly automatically renewing fee of $20.00 (the then-current fee as shown at signup). After signing up and unless otherwise cancelled, monthly billings will occur after a 7-day trial period, and will continue via automatic and recurring monthly billing on the same date each month (your billing anniversary date) to the original payment method. Members who enrolled under a prior published monthly rate may be subject to fee changes as described in the Price Increases section below. Upon cancellation, a member&rsquo;s access to the Academy will continue through the end of the current monthly billing period for which payment has already been made, after which access will cease. All fees paid are non-refundable. Cancellations do not entitle the member to a refund for any portion of the current billing period. If you have questions about the billing policy of the Academy, please contact: <a href="mailto:dara@thepipedpeony.com" className="text-black underline">dara@thepipedpeony.com</a>.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-black">Recurring Billing Notice</h2>
              <p className="text-gray-700 leading-relaxed">
                By enrolling in The Piped Peony Academy, you authorize The Piped Peony to charge your payment method automatically on a recurring monthly basis. You will be billed on the same date each month corresponding to your original enrollment date (your billing anniversary date). You will not receive individual advance notice before each monthly charge. It is your responsibility to cancel your membership prior to your next billing anniversary date if you do not wish to be charged.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Members of The Piped Peony Academy can cancel their membership at any time. Cancellations will take place prior to the next billing anniversary date, so long as the member has attempted to cancel prior to that date. To cancel a membership, a member must log in to their respective account, and cancel online through their customer portal. Questions regarding billing and cancellations should be sent to The Piped Peony through the Site&rsquo;s contact form. Cancellations submitted after a billing anniversary date has passed will not result in a refund for that billing period. The member will retain access to the Academy through the end of that paid monthly billing period and will not be charged again.
              </p>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                The website also offers a free 7-day trial, that The Piped Peony can cancel anytime. After the trial period, members will be billed automatically on a recurring monthly basis on their billing anniversary date, without individual advance notice of each charge, as described in the Recurring Billing Notice section above. Members can cancel anytime through their membership portal prior to the end of the trial period to avoid being charged.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                You are granted a non-exclusive, non-transferable, revocable license to access and use the Academy strictly in accordance with these terms of use. As a condition of your use of the Site, you warrant to The Piped Peony that you will not use the Site for any purpose that is unlawful or prohibited by these Terms. You may not use the Site in any manner which could damage, disable, overburden, or impair the Site or interfere with any other party&rsquo;s use and enjoyment of the Site. You may not obtain or attempt to obtain any materials or information through any means not intentionally made available or provided for through the Site.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                You agree to indemnify, defend and hold harmless The Piped Peony, its officers, directors, employees, agents and third parties, for any losses, costs, liabilities and expenses (including reasonable attorney&rsquo;s fees) relating to or arising out of your use of or inability to use the Site or services, any user postings made by you, your violation of any terms of this Agreement or your violation of any rights of a third party, or your violation of any applicable laws, rules or regulations. The Piped Peony reserves the right, at its own cost, to assume the exclusive defense and control of any matter otherwise subject to indemnification by you, in which event you will fully cooperate with The Piped Peony in asserting any available defenses.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                In the event the parties are not able to resolve any dispute between them arising out of or concerning these Terms and Conditions, or any provisions hereof, whether in contract, tort, or otherwise at law or in equity for damages or any other relief, then such dispute shall be resolved only by final and binding arbitration pursuant to the Federal Arbitration Act, conducted by a single neutral arbitrator and administered by the American Arbitration Association, or a similar arbitration service selected by the parties, in a location mutually agreed upon by the parties. The arbitrator&rsquo;s award shall be final, and judgment may be entered upon it in any court having jurisdiction. In the event that any legal or equitable action, proceeding or arbitration arises out of or concerns these Terms and Conditions, the prevailing party shall be entitled to recover its costs and reasonable attorney&rsquo;s fees. The parties agree to arbitrate all disputes and claims in regards to these Terms and Conditions or any disputes arising as a result of these Terms and Conditions, whether directly or indirectly, including Tort claims that are a result of these Terms and Conditions. The parties agree that the Federal Arbitration Act governs the interpretation and enforcement of this provision. The entire dispute, including the scope and enforceability of this arbitration provision shall be determined by the Arbitrator. This arbitration provision shall survive the termination of these Terms and Conditions.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                Any arbitration under these Terms and Conditions will take place on an individual basis; class arbitrations and class/representative/collective actions are not permitted. THE PARTIES AGREE THAT A PARTY MAY BRING CLAIMS AGAINST THE OTHER ONLY IN EACH&rsquo;S INDIVIDUAL CAPACITY, AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PUTATIVE CLASS, COLLECTIVE AND/OR REPRESENTATIVE PROCEEDING, SUCH AS IN THE FORM OF A PRIVATE ATTORNEY GENERAL ACTION AGAINST THE OTHER. Further, unless both you and The Piped Peony agree otherwise, the arbitrator may not consolidate more than one person&rsquo;s claims, and may not otherwise preside over any form of a representative or class proceeding.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                You agree that no joint venture, partnership, employment, or agency relationship exists between you and The Piped Peony as a result of this agreement or use of the Site. The Piped Peony&rsquo;s performance of this agreement is subject to existing laws and legal process, and nothing contained in this agreement is in derogation of The Piped Peony&rsquo;s right to comply with governmental, court and law enforcement requests or requirements relating to your use of the Site or information provided to or gathered by The Piped Peony with respect to such use. If any part of this agreement is determined to be invalid or unenforceable pursuant to applicable law including, but not limited to, the warranty disclaimers and liability limitations set forth above, then the invalid or unenforceable provision will be deemed superseded by a valid, enforceable provision that most closely matches the intent of the original provision and the remainder of the agreement shall continue in effect.
              </p>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed font-semibold">
                Notice of Upcoming Price Increase (existing members at prior rate): Effective April 22, 2026, the monthly membership fee for members who were enrolled at the prior rate of $15.00 per month will increase to $20.00. All such active members will receive email notification of this change on or before March 23, 2026, no less than thirty (30) days prior to the effective date, consistent with the notice requirement above. New memberships offered at $20.00 per month after the date new pricing takes effect on the Site are not affected by this specific transition notice.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                Payment shall be made to The Piped Peony through the Website, on the date of the online purchase of any of The Piped Peony&rsquo;s retail offerings, collectively referred to as the Goods (the &ldquo;Goods&rdquo;).
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                The Piped Peony welcomes your questions or comments regarding the Terms. If you have any questions or concerns, please email <a href="mailto:dara@thepipedpeony.com" className="text-black underline">dara@thepipedpeony.com</a>.
              </p>
            </section>
          </div>
        </div>
